<template>
	...
	<view class="container">
					 ...
					 <view class="uni-list-cell-db">
						 <picker @change="bindPickerChange" :value="index" :range="array">
							 <view class="uni-input">
								{{array[index]}} 
								<uni-icons type="arrowdown" size="15" color="#fff" :style="{marginLeft: '10rpx'}"/>
							 </view>
						 </picker>
					 </view>
				 </view>
		...
		<swiper class="slider" 
				...
				:duration="500">
			<swiper-item>
				<view><image class="img" mode="widthFix" src="https://i.imgur.com/CJGp3TO.png" /></view>
			</swiper-item>
			<swiper-item>
				<view><image class="img" mode="widthFix" src="https://i.imgur.com/CJGp3TO.png" /></view>
			</swiper-item>
		...
		<view class="services-wrapper">
			<RoundIcon type="home" size="20" color="#D6B88B" borderColor="#D6B88B" title="Hotels" />
			<RoundIcon type="shop" size="20" color="#D6B88B" borderColor="#D6B88B" title="Residence" />
			<RoundIcon type="paperclip" size="20" color="#D6B88B" borderColor="#D6B88B" title="Services" />
			<RoundIcon type="person" size="20" color="#D6B88B" borderColor="#D6B88B" title="Profile" />
		</view>
		
		<view class="projects-wrapper">
			<view class="projects-header">
				<text class="title">Projects</text> 
				<text class="view-more">View more 
					<uni-icons type="forward" size="15" color="#e2e2e2" />
				</text>
			</view>
			<scroll-view class="projects-scroll" 
						 scroll-x="true" 
						 :scroll-left="scrollLeft"
						 @scroll="scroll">
				<gesture @slideLeft="slideLeft" @slideRight="slideRight">
					<view class="scroll-item" v-for="(project, index) in projects" :key="index">
